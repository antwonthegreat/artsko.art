...
function Privacy() {
   return (
      ...
      <div style={{padding:16,marginTop:80, display:'flex',flexDirection:'column', backgroundColor:'#ffffff'}}>
        ...
        <p>
        Thank you for choosing to be part of our community at Artsko ("<strong>Company</strong>", "<strong>we</strong>", "<strong>us</strong>", "<strong>our</strong>"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at artsko@artsko.art.
        </p>
        <p>
        When you visit our website artsko.art (the "<strong>Website</strong>"), use our mobile application, as the case may be (the "<strong>App</strong>") and more generally, use any of our services (the "<strong>Services</strong>", which include the Website and App), we appreciate that you are trusting us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately.
        </p>
        ...
        <li><a href="#s4">HOW DO WE HANDLE YOUR SOCIAL LOGINS?</a></li>
        <li><a href="#s5">HOW LONG DO WE KEEP YOUR INFORMATION?</a></li>
        <li><a href="#s6">HOW DO WE KEEP YOUR INFORMATION SAFE?</a></li>
        <li><a href="#s7">WHAT ARE YOUR PRIVACY RIGHTS?</a></li>
        <li><a href="#s8">CONTROLS FOR DO-NOT-TRACK FEATURES</a></li>
        <li><a href="#s9">DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
        <li><a href="#s10">DO WE MAKE UPDATES TO THIS NOTICE?</a></li>
        <li><a href="#s11">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></li>
        <li><a href="#s12">HOW CAN YOU REVIEW, UPDATE OR DELETE THE DATA WE COLLECT FROM YOU?</a></li>
              </ol>
              <h2 id="s1">
        ...
        <p>
        <strong>Personal Information Provided by You.</strong> We collect usernames; names; email addresses; and other similar information.
        </p>

        <p>
        <strong>Payment Data.</strong> We may collect data necessary to process your payment if you make purchases, such as your payment instrument number (such as a credit card number), and the security code associated with your payment instrument. All payment data is stored by Stripe. You may find their privacy notice link(s) here: <a href="https://stripe.com/privacy">https://stripe.com/privacy</a>.
        </p>

        <p>
        <strong>Social Media Login Data.</strong> We may provide you with the option to register with us using your existing social media account details, like your Facebook, Twitter or other social media account. If you choose to register in this way, we will collect the information described in the section called <a href="#s4">"HOW DO WE HANDLE YOUR SOCIAL LOGINS?"</a> below.
        </p>
        ...
        <p  style={italicStyle}>
        <strong>In Short:</strong>  We collect information regarding your geolocation, mobile device, push notifications, when you use our App.
        </p>
        ...
        <ul>
        <li><span style={italicStyle}>Geolocation Information.</span> We may request access or permission to and track location-based information from your mobile device, either continuously or while you are using our App, to provide certain location-based services. If you wish to change our access or permissions, you may do so in your device's settings.</li>
        <li><span style={italicStyle}>Mobile Device Access.</span> We may request access or permission to certain features from your mobile device, including your mobile device's camera, storage, and other features. If you wish to change our access or permissions, you may do so in your device's settings.</li>
        <li><span style={italicStyle}>Mobile Device Data.</span> We automatically collect device information (such as your mobile device ID, model and manufacturer), operating system, version information and system configuration information, device and application identification numbers, browser type and version, hardware model Internet service provider and/or mobile carrier, and Internet Protocol (IP) address (or proxy server). If you are using our App, we may also collect information about the phone network associated with your mobile device, your mobile device’s operating system or platform, the type of mobile device you use, your mobile device’s unique device ID and information about the features of our App you accessed.</li>
        <li><span style={italicStyle}>Push Notifications.</span> We may request to send you push notifications regarding your account or certain features of the App. If you wish to opt-out from receiving these types of communications, you may turn them off in your device's settings.</li>
        </ul>
        ...
        <li><strong>To send you marketing and promotional communications.</strong> We and/or our third-party marketing partners may use the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. For example, when expressing an interest in obtaining information about us or our Services, subscribing to marketing or otherwise contacting us, we will collect personal information from you. You can opt-out of our marketing emails at any time (see the <a href="#s7">"WHAT ARE YOUR PRIVACY RIGHTS?"</a> below).</li>
        ...
        <p>
        In some regions (like the EEA and UK), you have certain rights under applicable data protection laws. These may include the right (i) to request access and obtain a copy of your personal information, (ii) to request rectification or erasure; (iii) to restrict the processing of your personal information; and (iv) if applicable, to data portability. In certain circumstances, you may also have the right to object to the processing of your personal information. To make such a request, please use the <a href="#s11">contact details</a> provided below. We will consider and act upon any request in accordance with applicable data protection laws.
        </p>
        ...
        <p>
        If you have questions or comments about your privacy rights, you may email us at artsko@artsko.art.
        </p>
        ...
        We have collected the following categories of personal information in the past twelve (12) months:
          ...
          <tr  style={tableStyle}>
            ...
            <th  style={tableStyle}>Examples</th>
            <th  style={tableStyle}>Collected</th>
          </tr>
          <tr  style={tableStyle}>
            <td  style={tableStyle}>A. Identifiers</td>
            <td  style={tableStyle}>Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address and account name</td>
            <td  style={tableStyle}>YES</td>
                </tr>
                <tr  style={tableStyle}>
        <td  style={tableStyle}>
        B. Personal information categories listed in the California Customer Records statute
        </td>
        <td  style={tableStyle}>Name, contact information, education, employment, employment history and financial information
        ...
        <td  style={tableStyle}>Gender and date of birth
        </td>
        <td  style={tableStyle}>
        NO</td>
        ...
        <td  style={tableStyle}>Transaction information, purchase history, financial details and payment information
        </td>
        <td  style={tableStyle}>
        YES
        </td>
        ...
        <td  style={tableStyle}>Fingerprints and voiceprints
        </td>
        <td  style={tableStyle}>
        NO
        </td>
        ...
        <td  style={tableStyle}>Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems and advertisements
        </td>
        <td  style={tableStyle}>
        NO</td>
        ...
        <td  style={tableStyle}>Device location
        </td>
        <td  style={tableStyle}>
        YES</td>
        ...
        <td  style={tableStyle}>Images and audio, video or call recordings created in connection with our business activities
        </td>
        <td  style={tableStyle}>
        NO</td>
        ...
        <td  style={tableStyle}>Business contact details in order to provide you our services at a business level, job title as well as work history and professional qualifications if you apply for a job with us
        </td>
        <td  style={tableStyle}>
        NO
        </td>
        ...
        <td  style={tableStyle}>Student records and directory information
        </td>
        <td  style={tableStyle}>
        NO</td>
        ...
        <td  style={tableStyle}>Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual’s preferences and characteristics
        </td>
        <td  style={tableStyle}>
        NO
        </td>
        ...
        <p>
        You may contact us by email at artsko@artsko.art, or by referring to the contact details at the bottom of this document.
        </p>
        ...
        <p>
        Artsko has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding 12 months. Artsko will not sell personal information in the future belonging to website visitors, users and other consumers.
              </p>
              <h3>
        Your rights with respect to your personal data
        </h3>

        <p style={underlineStyle}>
        ...
        <li>To exercise these rights, you can contact us by email at artsko@artsko.art, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</li>
        </ul>
        <h2 id="s10">
        ...
        <p>
        If you have questions or comments about this notice, you may email us at artsko@artsko.art
        </p>
        ...
        <p>
        Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please submit a request form by clicking <a href="https://app.termly.io/notify/cdc8adbe-f2fe-4f23-a24f-b30d64591fe3">here</a>.
